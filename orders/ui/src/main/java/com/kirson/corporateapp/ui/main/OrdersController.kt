...
import com.kirson.corporateapp.orders.ui.R
...
import com.kirson.corporateapp.ui.main.OrdersScreen.ErrorMessage
import com.kirson.corporateapp.ui.main.OrdersScreen.ViewIntents

internal class OrdersController : KodeBankBaseController<OrdersScreen.ViewState, ViewIntents>() {
  ...
  @Composable
  override fun ScreenContent(state: OrdersScreen.ViewState) {
    Box(
        modifier = Modifier
            .statusBarsPadding()
